...
cover: /images/ligne-6/rev6-chartres-main.png
---
...
### Piste cyclable le long de la piscine de Bréquigny

Le REV débute par une piste cyclable unidirectionnelle le long de la piscine de Bréquigny. Bien que sa largeur soit d'environ 2 mètres, on ne peut pas en utiliser toute la surface : le bord côté route donne un effet de "précipice", ce qui oblige les cyclistes à se rabattre vers l’intérieur de la piste pour éviter de frôler la chaussée.

![](/images/ligne-6/rev6-chartres-brequigny-1.png)

### Boviduc de Bréquigny

Avant d'arriver au boviduc permettant de franchir la rocade, les usagers sont amenés à emprunter une voie verte. Celle-ci est difficile d'accès avec des potelets beaucoup trop proches les uns des autres. Aucune signalisation propre au REV n'est visible à cet endroit rendant l'itinéraire peu lisible.

![](/images/ligne-6/rev6-chartres-tunnel-2.png)

Le boviduc de Bréquigny permet de passer du parc de Bréquigny à l’autre côté de la rocade. Il est fréquemment inondé, mais des travaux réalisés durant l’été 2025 sont censés y avoir remédié. Côté nord, le vélotour part à gauche vers Cleunay, à droite vers Alma. Le REV continue vers Rennes vers le Nord avec un léger décroché vers la gauche afin de rejoindre la rue d'Angleterre.

![](/images/ligne-6/rev6-chartres-tunnel-1.png)

### Vélorue voie agricole

L'itinéraire se poursuit via un ancien chemin agricole qui a été déplacé lors de l'élargissement de la 2x2 voies et qui est partagé avec le REV. Le trafic y est limité (un seul riverain habite le long de cette route) et cette route relie le boviduc de Bréquigny au Vallon. Cette vélorue est donc régulièrement très sale (boue) rendant obligatoire le port d’un pantalon de pluie et de surchaussures. La vélorue fait un léger décroché pour faire le tour du parking routier avant de franchir une traversée prioritaire pour rejoindre la piste séparée du Vallon.

![](/images/ligne-6/rev6-chartres-voie-agricole-1.png)

### Vallon

L'accès au Vallon se fait via une traversée sur plateau sur laquelle les cyclistes sont prioritaires. On constate cependant régulièrement, par temps froid, la présence de verglas sur cette section ce qui rend la traversée dangereuse.

![](/images/ligne-6/rev6-chartres-vallon-1.png)

Un peu plus loin, tous les jours, des automobilistes viennent se garer illégalement entre 12h et 14h sur les espaces verts et le trottoir en face du resto/bar du Vallon, et ce en roulant sur la piste cyclable pour y aller et en repartir. Rennes Métropole avait mis des roches pour empêcher cela lorsque la piste avait été créé mais elles ont vite disparues. Le vice président et les services de Rennes Métropole ont confirmé lors d'une réunion au printemps 2024 que c'était des particuliers qui avaient illégalement enlevé les roches mais que Rennes Métropole ne comptait pas en remettre car cela leur revient cher. De plus Rennes Métropole n'a pas la compétence police à Noyal, uniquement la compétence voirie. La Police Municipale de Noyal et la gendarmerie ont la compétence mais ne se déplacent pas malgré les promesses.
::content-image
---
