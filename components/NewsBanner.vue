<template>
  <div v-if="lastNewsItem" class="relative isolate flex items-center gap-x-6 overflow-hidden bg-ra-green-100 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
    <div class="absolute left-[max(-7rem,calc(50%-52rem))] top-1/2 -z-10 -translate-y-1/2 transform-gpu blur-2xl" aria-hidden="true">
      <div class="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-ra-orange to-[#9089fc] opacity-70" style="clip-path: polygon(74.8% 41.9%, 97.2% 73.2%, 100% 34.9%, 92.5% 0.4%, 87.5% 0%, 75% 28.6%, 58.5% 54.6%, 50.1% 56.8%, 46.9% 44%, 48.3% 17.4%, 24.7% 53.9%, 0% 27.9%, 11.9% 74.2%, 24.9% 54.1%, 68.6% 100%, 74.8% 41.9%)" />
    </div>
    ...
    <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
      ...
      <NuxtLink to="/historique" class="flex-none text-ra-green-600 py-1 text-sm font-semibold hover:underline">
